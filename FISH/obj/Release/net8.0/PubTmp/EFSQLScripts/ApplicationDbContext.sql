...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20240703075413_identityupdate'
)
BEGIN
...
BEGIN
    CREATE TABLE [Orders] (
        ...
        [OrderCreateDateTime] datetime2 NOT NULL,
        [GetMySelfDateTime] datetime2 NOT NULL,
        [OrderType] nvarchar(100) NOT NULL,
        [Count] int NOT NULL,
        [OrderDetail] nvarchar(max) NOT NULL,
        [OrderAmount] decimal(18,2) NOT NULL,
        [PricingMethod] nvarchar(max) NOT NULL,
        [DeliveryMethod] nvarchar(max) NOT NULL,
        [DeliveryTime] datetime2 NOT NULL,
        [DeliveryAddress] nvarchar(max) NOT NULL,
        [ContactNumber] nvarchar(10) NOT NULL,
        [IsDeleted] bit NOT NULL,
        [IsSeleted] bit NOT NULL,
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20240703075413_identityupdate', N'8.0.6');
END;
GO
