namespace FISH.Model
{
    ...
    public class Orders
    {
        ...
        /// </summary>
        [Required, StringLength(10), Display(Name = "姓名")]
        public string Name { get; set; }

        /// <summary>
        /// Gets or sets the date and time when the order was created.
        /// </summary>
        [Required, Display(Name = "建單時間")]
        ...
        /// </summary>
        [Required, Display(Name = "自取時間")]
        public DateTime GetMySelfDateTime { get; set; }

        /// <summary>
        /// Gets or sets the type of the order.
        /// </summary>
        [Required, StringLength(100), Display(Name = "訂單類型")]
        public string OrderType { get; set; }

        /// <summary>
        /// Gets or sets the detailed description of the order.
        /// </summary>
        [Required, Display(Name = "訂單數量")]
        public int Count { get; set; }

        /// <summary>
        /// Gets or sets the detailed description of the order.
        /// </summary>
        [Required, Display(Name = "訂單明細")]
        public string OrderDetail { get; set; }

        /// <summary>
        /// Gets or sets the total amount of the order.
        /// </summary>
        [Required, Display(Name = "訂單總金額"), DataType(DataType.Currency)]
